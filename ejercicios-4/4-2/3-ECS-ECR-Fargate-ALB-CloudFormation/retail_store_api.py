...
def whoami():
    """
    Endpoint para identificar el contenedor (útil para balanceo de carga).
    Retorna:
        dict: Un diccionario con el nombre del host del contenedor.
    """
...
async def create_item(item: TaggedItem):
    """
    Endpoint de items. Recibe un item y lo guarda en el diccionario de my_items.
